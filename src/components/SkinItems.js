...
function SkinItems(){
    ...
    const items = [
        { id: '0', source: item5, price: '18.40', name: 'Estée Lauder Double Wear Concealer', heartState: 'empty_heart' },
        { id: '1', source: item3, price: '13.11', name: "L'Oréals Paris Matte Lipstick", heartState: 'empty_heart' },
        { id: '2', source: item6, price: '20.00', name: "Fenty Beauty Pro Filt'r Primer", heartState: 'empty_heart' },
        { id: '3', source: item8, price: '16.75', name: 'Huda Beauty Liquid Matte Lipstick', heartState: 'empty_heart' },
        { id: '4', source: item9, price: '21.99', name: 'NARS Radiant Creamy Concealer', heartState: 'empty_heart' },
        { id: '5', source: item4, price: '7.30', name: 'NYX Professional Eyeshadow Palette', heartState: 'empty_heart' },
        { id: '6', source: item0, price: '13.76', name: 'INGLOT AMC Eyerliner Gel 5.5g', heartState: 'empty_heart' },
        { id: '7', source: item1, price: '12.50', name: 'Maybelline Sky High Mascara', heartState: 'empty_heart' },
        { id: '8', source: item7, price: '10.99', name: 'Urban Decay Setting Spray', heartState: 'empty_heart' },
        { id: '9', source: item2, price: '9.99', name: 'Revlon ColorStay Foundation', heartState: 'empty_heart' }
    ];
